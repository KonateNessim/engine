...
class DataType {
  ...
  #[ORM\Column(length:100)] private string $phpType;
  #[ORM\Column(length:100)] private string $jsType;
  ...
  public function getPhpType(): string {return $this->phpType;}
  public function setPhpType(string $t): void {$this->phpType=$t;}
  public function getJsType(): string {return $this->jsType;}
  public function setJsType(string $t): void {$this->jsType=$t;}
