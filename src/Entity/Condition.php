...
class Condition
{
  ...
  private ?ConditionGroup $groupCondition = null;
  ...
  {
    return $this->groupCondition ? $this->groupCondition->getLine() : null;
  }

  public function getGroupCondition(): ?ConditionGroup
  {
    return $this->groupCondition;
  }

  public function setGroupCondition(?ConditionGroup $groupCondition): static
  {
